export const LABELS = {
  ...
  print1:
    "La stampa che proponiamo è una stampa di qualità. Nel tempo l'usura è minima e il colore non sbiadisce. È possibile stampare ovunque: sulle maniche di una maglietta a maniche lunghe o sul cappuccio di una felpa.",
  print2:
    "Spesso viene scelta la stampa a caldo al posto del ricamo. Il ricamo tuttavia è ricercato e sempre di moda, è piacevole al tatto e crea un piccolo rilievo sul capo che lo rende unico.",
  about:
    "Siamo dinamici. Siamo creativi. Siamo simpatici. Siamo aperti a qualsiasi forma di collaborazione. Per qualsiasi domanda o informativa siamo disponibili a essere contattai. Saint Mary Boulevard, we brand where we live!",
};
